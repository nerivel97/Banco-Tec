...
<head>
    ...
    <title>Iniciar Sesion Banco del TEC</title>
        ...
        <div class="row">
            <div class="form-section">
                <div class="form-wrapper">
                    ...
                    <h1 class="login-header">Bienvenido al Banco del TEC</h1>
                    <!-- Login Form  -->
                    <form action="../scripts/login_auth.php" method="POST">
                        <label class="login-label" for="accountNumber">Numero de Cuenta</label>
                        ...
                        <button class="elevatedButton login-label" name="submit" type="submit">Iniciar Sesion</button>
                    </form>
                    <p class="register-link">No tienes una cuenta? <a class="no-underline reg-log"
                            href="register.php">Registrarse</a></p>
                    <!-- Social Icons  -->
